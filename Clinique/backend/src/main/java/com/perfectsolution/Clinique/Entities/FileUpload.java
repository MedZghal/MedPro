...
@NamedQueries({
    ...
    @NamedQuery(name = "FileUpload.findByPatient", query = "SELECT f FROM FileUpload f WHERE f.numPatient.numFichPatient = :numPatient"),
...
public class FileUpload implements Serializable {
    ...
    public String toString() {
        return "com.rest.entities.FileUpload[ id=" + id + " ]";
    }
