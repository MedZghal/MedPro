 ...
 */
@Service
public class NotificationMetierImpl {
  ...
  public void chatSend(Notification notification, String username) {
    messagingTemplate.convertAndSendToUser(
      username, 
      "/queue/chatSend", 
      notification
   ...
   public void chatRecive(Notification notification, String username) {
    messagingTemplate.convertAndSendToUser(
      username, 
      "/queue/chatRecive", 
      notification
