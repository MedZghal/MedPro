...
@NamedQueries({
    ...
    @NamedQuery(name = "FichPatient.findByFichPatient", query = "SELECT f.partage FROM FichPatient f WHERE f.fichPatientPK.numPatient = :numPatient and f.fichPatientPK.codeMedTrit = :codeMedTrit"),
    ...
    @NamedQuery(name = "FichPatient.findAllByCodeMedTrit", query = "SELECT f.patient FROM FichPatient f WHERE f.fichPatientPK.codeMedTrit = :codeMedTrit"),
    @NamedQuery(name = "FichPatient.findByCodeMedTrit", query = "SELECT f.patient FROM FichPatient f WHERE f.fichPatientPK.codeMedTrit = :codeMedTrit and LOCATE('partagé',f.partage)=0"),
    @NamedQuery(name = "FichPatient.findDPByCodeMedTrit", query = "SELECT f.patient FROM FichPatient f WHERE f.fichPatientPK.codeMedTrit = :codeMedTrit and LOCATE('partagé',f.partage)!=0"),
