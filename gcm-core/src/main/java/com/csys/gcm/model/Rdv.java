...
@NamedQueries({
    ...
    @NamedQuery(name = "Rdv.findByADate", query = "SELECT r FROM Rdv r WHERE r.startDate = CURRENT_TIMESTAMP and r.fichPatient.fichPatientPK.codeMedTrit= :codeMedTrit"),
    @NamedQuery(name = "Rdv.findByNumMedecin", query = "SELECT r FROM Rdv r WHERE r.fichPatient.fichPatientPK.codeMedTrit = :codeMedTrit ORDER BY r.startDate"),
