                                                                             ...
                                                                             <div class="panel panel-default">
                                                                                <div class="panel-heading">
                                                                                 ...
                                                                                 <div class="pull-right" id="btAction" style=" margin-top: -69px; margin-right: 25px; ">
                                                                                                <a class="btn tooltips pull-right" id="create_pdf" style="margin-top: 12px;margin-left: 20px;margin-bottom: 15px;margin-right: 13px;" data-tooltip="tooltip" data-placement="bottom" title="" data-original-title="Imprimer." href="javascript:GetPrint();">
                                                                                                                      <img style="width: 35px;" src="../img/printer.png" alt="">
                                                                                                      </a>
                                                                                                   <a class="btn tooltips pull-right" id="AddMedic" style="margin-top: 12px;margin-left: 20px;" data-tooltip="tooltip" data-placement="bottom" title="" data-original-title="Ajouter Dépense.">
                                                                                                                      <img style="width: 35px;" src="../img/Money-icon.png" alt="">
                                                                                                      </a>
                                                                                  </div>
                                                                                </div>
