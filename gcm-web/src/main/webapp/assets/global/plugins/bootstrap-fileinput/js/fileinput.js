 ...
 */
function printbtnImg(){
    w=window.open();
    w.document.write($('.kv-zoom-body').html());
    w.print();
    w.close();
}
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <div class="kv-zoom-actions pull-right">{printbtn}{toggleheader}{fullscreen}{borderless}{close}</div>\n' +
        ...
        _getModalContent: function () {
            ...
            return self._getLayoutTemplate('modal').setTokens({
                ...
                'printbtn':self._getZoomButton('printbtn'),
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            printbtn :'<i class="glyphicon glyphicon-print"></i>',
        ...
        previewZoomButtonClasses: {
            ...
            printbtn :'btn btn-default printbtn',
            toggleheader: 'btn btn-default btn-header-toggle',
            fullscreen: 'btn btn-default hide',
            borderless: 'btn btn-default hide',
